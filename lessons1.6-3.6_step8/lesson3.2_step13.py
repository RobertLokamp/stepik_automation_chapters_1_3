...
class TestRegistration(unittest.TestCase):
    def test_registration1(self):
        ...
        input3.send_keys("ivanpetrov@stepik.ru")
        ...
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "welcome text is not equal default welcome text")
