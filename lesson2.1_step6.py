...
#проверяем значение атрибута checked у robot_checkbox
    robots_checkbox = browser.find_element_by_id('robotCheckbox')
    robots_checkbox = robots_checkbox.get_attribute('checked')
    print('value of robots_checkbox radio: ', robots_checkbox)
    assert robots_checkbox is None, 'Robot checkbox is not selected by default'
